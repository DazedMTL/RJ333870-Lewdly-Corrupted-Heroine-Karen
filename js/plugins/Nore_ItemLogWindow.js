    ...
    (function (ItemLogWindow) {
        ...
        Window_Base.prototype.addIcon = function (iconIndex, x, y) {
            ...
            if (!baseTexture) {
                ...
                baseTexture = new PIXI.BaseTexture(bitmap._image, PIXI.settings.SCALE_MODE);
        ...
        var Window_ItemLog = /** @class */ (function (_super) {
            ...
            function Window_ItemLog(item, yIndex, callback, yPlus) {
                ...
                var _this = _super.call(this, new Rectangle(0, yIndex * 80 + 4 + yPlus, Graphics.boxWidth - 380, 90)) || this;
                _this.padding = 3;
            ...
            Window_ItemLog.prototype.refresh = function () {
                ...
                if (item.atypeId == 11 && item.meta['hint']) {
                    text = item.meta['hint'];
                }
        ...
        var Window_SkillLog = /** @class */ (function (_super) {
            __extends(Window_SkillLog, _super);
            function Window_SkillLog(item, callback) {
                var _this = _super.call(this, new Rectangle(0, 4 + 0, Graphics.boxWidth - 380, 90)) || this;
                _this.padding = 3;
                _this._updateContents();
                _this._item = item;
                _this.callback = callback;
            ...
            Window_SkillLog.prototype.refresh = function () {
                this.contents.clear();
                var item = this._item;
                var xx = 40;
                var yy = 30;
            ...
            Window_SkillLog.prototype.update = function () {
                _super.prototype.update.call(this);
                this.appearFrame--;
                if (this.appearFrame > 0) {
                    this.opacity += 25;
        ...
        Scene_Map.prototype.updateMain = function () {
            ...
            if (logItem) {
                ...
                if (SceneManager._scene._spriteset) {
                    if (SceneManager._scene._spriteset._medalUpdateSprite) {
                        yPlus = SceneManager._scene._spriteset._medalUpdateSprite.getBottom();
                    }
                }
            ...
            var skill = $gameTemp.nextSkillLog();
            if (skill) {
                this._logWindowList = this._logWindowList || [];
                var yIndex = this.getLogWindowY();
                var yPlus = 0;
                ...
                window = new Window_SkillLog(skill, onFinish);
                this._logWindowList.push(window);
                this.addWindow(window);
                var self = this;
            }
