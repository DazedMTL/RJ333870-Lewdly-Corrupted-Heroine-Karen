...
(function (Nore) {
    ...
    (function (Tes) {
        ...
        var COSTOM_FADE_IN_OUT = parameters['customFadeInOut'].toLowerCase() === 'true';
        ...
        Tes.DATA_PATH = function () {
            var p = window.location.pathname.replace(/(\/www|)\/[^\/]*$/, '/' + SCENARIO_FOLDER_NAME + '/');
            if (p.match(/^\/([A-Z]\:)/)) {
                p = p.slice(1);
            }
            var result = decodeURIComponent(p);
        ...
        DataManager.loadScenarioFile = function (name, src) {
            ...
            xhr.onload = function () { return _this.onXhrLoad(xhr, name, src, url); };
            xhr.onerror = function () { return _this.onXhrError(name, src, url); };
            xhr.send();
        };
        ...
        var Scenario_Converter = /** @class */ (function () {
            ...
            Scenario_Converter.prototype.convertAll = function () {
                ...
                this._replaceMap = {};
                var scenario = {};
                fs.readdir(Tes.SCENARIO_SRC_PATH, function (err, files) {
                    if (err) {
                    ...
                    try {
                        ...
                        self.convertFiles(Tes.SCENARIO_SRC_PATH, files, scenario);
                        //console.log(scenario);
                        if (!fs.existsSync(Tes.DATA_PATH)) {
                            fs.mkdirSync(Tes.DATA_PATH);
                        }
                        fs.writeFileSync(Tes.DATA_PATH + 'Scenario.json', JSON.stringify(scenario));
            ...
            Scenario_Converter.prototype.convertCommand_m = function (mobId, context) {
                ...
                context.push({ 'code': 101, 'indent': this.indent, 'parameters': [actor, index, 0, 2, name] });
            ...
            Scenario_Converter.prototype.convertCommand_messages = function (context, faceActorId, argFaceFile, argFaceIndex, argName) {
                ...
                context.push({ 'code': 101, 'indent': this.indent, 'parameters': [faceName, faceIndex, back, pos, actorName] });
                for (var _i = 0, _a = context.data; _i < _a.length; _i++) {
                    var msg = _a[_i];
                    context.push({ 'code': 401, 'indent': this.indent, 'parameters': [this.replaceMessage(msg)] });
                }
            ...
            Scenario_Converter.prototype.convertCommand_message_h = function (context) {
                ...
                var pos = this.convertPosMz(context.headerInt('pos', 0));
                var name = context.headerStr('name');
                context.push({ 'code': 101, 'indent': this.indent, 'parameters': [actor, index, back, pos, name] });
                for (var _i = 0, _a = context.data; _i < _a.length; _i++) {
                    var msg = _a[_i];
             ...
             * ○ 数値入力
             */
            Scenario_Converter.prototype.convertCommand_input_num = function (context) {
                var variable = context.headerInt('var');
                var num = context.headerInt('num');
                context.push({ 'code': 103, 'indent': this.indent, 'parameters': [variable, num] });
            };
            /**
             * ○ アイテム選択の処理
             */
            Scenario_Converter.prototype.convertCommand_choice_item = function (context) {
                var variable = context.headerInt('var');
                var type = context.headerInt('type', 2);
                context.push({ 'code': 104, 'indent': this.indent, 'parameters': [variable, type] });
            };
            /**
             * ○ 文章スクロール表示（ヘッダー部）
             */
            Scenario_Converter.prototype.convertCommand_scroll_h = function (context) {
                var noskip = context.headerBool('noskip', false);
                var speed = context.headerInt('speed');
                context.push({ 'code': 105, 'indent': this.indent, 'parameters': [speed, noskip] });
                for (var _i = 0, _a = context.data; _i < _a.length; _i++) {
                    var msg = _a[_i];
            ...
            Scenario_Converter.prototype.convertCommand_if_actor = function (context) {
                ...
                switch (context.headerStr('type')) {
                    ...
                    case 'class':
                        type = 2;
                        new Tes.NotEmptyValidator().validate(context, 'value', context.header['value']);
                        new Tes.NumericValidator(1).validate(context, 'value', context.header['value']);
                        value = context.headerInt('value');
                        break;
                    case 'skill':
                        type = 3;
            ...
            Scenario_Converter.prototype.convertCommand_loop_end = function (context) {
                this.indent--;
                context.push({ 'code': 413, 'indent': this.indent, 'parameters': [] });
            };
            Scenario_Converter.prototype.convertCommand_loop_break = function (context) {
            ...
            Scenario_Converter.prototype.convertCommand_money = function (context) {
                ...
                context.push({ 'code': 125, 'indent': this.indent, 'parameters': [operate, type, money] });
            };
            /**
             * ○ アイテムの増減
             */
            Scenario_Converter.prototype.convertCommand_item = function (context) {
                ...
                context.push({ 'code': 126, 'indent': this.indent, 'parameters': [id, operate, type, num] });
            };
            /**
             * ○ 武器の増減
             */
            Scenario_Converter.prototype.convertCommand_weapon = function (context) {
                ...
                var operate = regOp.exec(value) ? 1 : 0; // 0:加算 1:減算
                var num = this.convertVarValue(type, value);
                context.push({ 'code': 127, 'indent': this.indent, 'parameters': [id, operate, type, num, equip] });
            };
            /**
             * ○ 防具の増減
             */
            Scenario_Converter.prototype.convertCommand_armor = function (context) {
                ...
                var operate = regOp.exec(value) ? 1 : 0; // 0:加算 1:減算
                var num = this.convertVarValue(type, value);
                context.push({ 'code': 128, 'indent': this.indent, 'parameters': [id, operate, type, num, equip] });
            };
            ...
            Scenario_Converter.prototype.convertCommand_route = function (context, line) {
                ...
                if (isNaN(code)) {
                    switch (type) {
                        ...
                        case 'jump':
                            code = 14;
                            new Tes.NumericValidator(-100, 100).validate(context, 'x', header['x']);
                            new Tes.NumericValidator(-100, 100).validate(context, 'y', header['y']);
                            parameters.push(header.headerInt('x', 0));
                            parameters.push(header.headerInt('y', 0));
                            break;
                        case 'wait':
                            code = 15;
                            new Tes.NumericValidator(1, 999).validate(context, 'time', header['time']);
                        ...
                        case 'change_speed':
                            code = 29;
                            new Tes.NumericValidator(1, 6).validate(context, 'speed', header['speed']);
                            parameters.push(header.headerInt('speed', 3));
                            break;
                        case 'change_freq':
                            code = 30;
                            new Tes.NumericValidator(1, 5).validate(context, 'freq', header['freq']);
                        ...
                        case 'change_graphic':
                            code = 41;
                            new Tes.NotEmptyValidator().validate(context, 'file', header['file']);
                            new Tes.NotEmptyValidator().validate(context, 'index', header['index']);
                            new Tes.NumericValidator(0, 7).validate(context, 'index', header['index']);
                            parameters.push(header.headerStr('file'));
                            parameters.push(header.headerInt('index'));
                            break;
                        case 'change_opacity':
                            code = 42;
                            new Tes.NumericValidator(0, 255).validate(context, 'opacity', header['opacity']);
                            parameters.push(header.headerInt('opacity', 255));
                            break;
                        case 'change_blend':
                            code = 43;
                            new Tes.NumericValidator(0, 2).validate(context, 'blend', header['blend']);
                            parameters.push(header.headerInt('blend', 0));
                            break;
                        case 'play_se':
                            code = 44;
                            new Tes.NumericValidator(0, 100).validate(context, 'volume', header['volume']);
                            new Tes.NumericValidator(50, 150).validate(context, 'pitch', header['pitch']);
                            new Tes.NumericValidator(-100, 100).validate(context, 'pan', header['pan']);
                        ...
                        case 'script':
                            code = 45;
                            new Tes.NotEmptyValidator().validate(context, 'script', header['script']);
            ...
            Scenario_Converter.prototype.convertCommand_plugin = function (context) {
                ...
                context.push({ 'code': 357, 'indent': this.indent, 'parameters': parameters });
            };
