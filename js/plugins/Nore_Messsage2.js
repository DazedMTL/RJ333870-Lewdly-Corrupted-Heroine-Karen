...
Scene_Message.prototype.update = function () {
    ...
    if (Input.isTriggered('tab') || (this._messageVisible === false && Input.isTriggered('ok'))) {
        if (this._messageVisible === undefined) {
            this._messageVisible = true;
        }
        this._messageVisible = !this._messageVisible;
        /*if (this._messageWindowRogue) {
            this._messageWindowRogue.setMessageVisible(this._messageVisible);
        }*/
        if (this._messageWindow) {
            this._messageWindow.setMessageVisible(this._messageVisible);
        }
    }
};
...
Window_Message.prototype.startMessage = function () {
    if (Nore.BackLog) {
        Nore.BackLog.$gameBackLog.addLog($gameMessage.speakerName(), $gameMessage.allText());
    }
    Window_Message_prototype_startMessage.call(this);
};
var Window_Message2 = /** @class */ (function (_super) {
    __extends(Window_Message2, _super);
    ...
    Window_Message2.prototype.startMessage = function () {
        ...
        Window_Message_prototype.call(this);
