...
(function (Nore) {
    ...
    PluginManager.registerCommand(pluginName, 'Show', function (args) {
        ...
        SceneManager._scene.showSikyuSprite(x, y, scale, angle, type);
    });
    PluginManager.registerCommand(pluginName, 'StartChinpo', function (args) {
        ...
        SceneManager._scene.startChinpo(chinpoType, chinpoSize, chinpoIn, chinpoOut, outStart);
    });
    ...
    Scene_Map.prototype.showSikyuSprite = function (x, y, scale, angle, type) {
        if (!this._sikyuSprite) {
            this._sikyuSprite = new Sprite_Sikyu();
            this.addChild(this._sikyuSprite);
        }
        this._sikyuSprite.show(x, y, scale, angle, type);
    };
    Scene_Map.prototype.startChinpo = function (chinpoType, chinpoSize, chinpoIn, chinpoOut, outStart) {
        this._sikyuSprite.startChinpo(chinpoType, chinpoSize, chinpoIn, chinpoOut, outStart);
    };
    ...
    var Sprite_Sikyu = /** @class */ (function (_super) {
        ...
        Sprite_Sikyu.prototype.show = function (x, y, scale, angle, type) {
            this.x = x;
            this.y = y;
        ...
        Sprite_Sikyu.prototype.startChinpo = function (chinpoType, chinpoSize, chinpoIn, chinpoOut, outStart) {
