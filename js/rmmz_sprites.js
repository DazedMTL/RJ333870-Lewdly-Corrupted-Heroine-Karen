    ...
    if (this._battler) {
        switch (this._statusType) {
            case "hp":
                ...
                this._lastValue = this._battler.mhp;
            ...
            case "mp":
                ...
                this._lastValue = this._battler.mmp;
                return this._lastValue;
            case "tp":
...
Sprite_Picture.prototype.updateOrigin = function () {
    ...
    if (picture.origin() === 0) {
        ...
        this.anchor.y = 0.5;
        if (this._eroSprite) {
            this._eroSprite.anchor.x = 0.5;
            this._eroSprite.anchor.y = 0.5;
            this._eroSprite.rotation = picture._rotation / 180 * Math.PI;
        }
    }
};
